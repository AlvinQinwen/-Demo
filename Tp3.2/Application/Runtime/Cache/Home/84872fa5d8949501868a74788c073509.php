...
<body id="message" onselectstart="return true;" ondragstart="return false;">
			...
			<div class="window" id="windowcenter">
  			...
  			<div class="history">
				<div class="history-date">
					<ul>
						<form method="post" action="<?php echo U('home/liuyan/select');?>" id="form2">
						<li>开始时间：
						...
						<?php if(is_array($msgs)): foreach($msgs as $key=>$msg): ?><li class="green bounceInDown">
							<h3>
								<img src="/Public/message//logo100x100.jpg"><?php echo ($msg["name"]); ?><span><?php echo date('Y-m-d',$msg['create_at']);?></span>
									<div class="clr"></div>
							</h3>
							<dl>
						...
						<li class="green bounceInDown nob ly2" style="display:none;">
							<form action="<?php echo U('home/liuyan/add');?>" method="post" class="form1">
							<dl>
								<dt>
	...
	<script type="text/javascript" src="/Public/message/layerdate/laydate	.js"></script>
	<script type="text/javascript" src="/Public/message/layer/layer.js"></script>
